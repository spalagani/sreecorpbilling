...
<head>
  ...
  <title>Sree Broadband | CMS Dashboard</title>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo $serverurl ?>bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo $serverurl ?>bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="<?php echo $serverurl ?>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
