            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Operator Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Operator Location</label>
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Operator Location">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputFile">Operator Logo</label>
