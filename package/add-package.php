            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Package Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Package Description</label>
                  <textarea class="form-control" placeholder="Package Description"></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Package Price</label>
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Package Price">
                </div>
                <div class="form-group">
