            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Opeartor</label>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Cafno</label>
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Cafno">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="exampleInputFile">User ID Proof</label>
                  <input type="file" id="exampleInputFile">
